---
layout: default
title: Keyword Driven Model
permalink: /keyword_model_in_taf.html
heading: Keyword Driven Model
toc: true
---

#Keyword Driven Model

In case you decide to use a keyword driven framework for your web-application testing and is thinking to develop framework for the same, then you can simply use TAF as your framework. TAF consists of an in-built **plug-n-play** keyword driven automation framework. Users are only required to define their keywords definitions in a class file and let TAF know about it. Once done you can simply write your keyword driven tests in csv and excel format and start using them with TAF. Please go through the following links to understand it better:
<ul>
<li><a href="#simple_keyword_test">Simple keyword based test-case</a></li>
<li><a href="#testsuite">Test Suite Support</a></li>
<li><a href="#testreporting">Reporting</a></li>
</ul>
<a name="simple_keyword_test"> </a>
##Simple Keyword Based Test-case

To define your keywords just define your keyword as public methods in a class by extending the [_**KeywordBase**_]() class or the [_**IKeyword**_]() interface of TAF framework. 
...
The test files mentioned for the test-cases are similar to those as mentioned in the above example of <a href="#example">Simple keyword based test-case</a>. 
